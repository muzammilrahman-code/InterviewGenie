    ...
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mt-7 mb-12">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">
          ...
          InterviewGenie: Your Interview Preparation Companion
        </h1>
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
        {steps.map((step, index) => (
          <div 
            key={step.title} 
            className="bg-white p-5 rounded-lg shadow-md border border-gray-100 transition-transform hover:scale-105"
          >
      ...
      <div className="text-center mt-12">
        <Link to="/dashboard" className="bg-indigo-600 text-white px-8 py-3 rounded-full text-lg font-medium hover:bg-indigo-700 transition-colors shadow-lg">
